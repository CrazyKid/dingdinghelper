...
public interface DingAlarmService {
     ...
     * @param content      纯文本内容
     * @param atAll        是否@所有人
     * @param actionObject 通知对象
     * @return 是否发送成功
     */
    boolean sendCleanText(String content, boolean atAll, AlarmActionObject actionObject);
     ...
     * @return
     */
    boolean sendCleanText(String content, List<String> phoneList, AlarmActionObject actionObject);
     ...
     * @return 是否发送成功
     */
    boolean sendLink(String title, String content, String picUrl, String linkUrl, AlarmActionObject actionObject);
     ...
     * @return 是否发送成功
     */
    boolean sendMarkdown(String title, String markdownText, AlarmActionObject actionObject);
}
